...
$routes->get('/backpack', 'department::backpack');
$routes->get('/belt', 'department::belt');
$routes->get('/hat', 'department::hat');
$routes->get('/shoes', 'department::shoes');
$routes->get('/stationery', 'department::stationery');

                        ...
                        <ul>
                            ...
                            <li><a href="#">Pages</a>
                                <ul class="header__menu__dropdown">
                                    ...
                                    <li><a href="<?= base_url(); ?>/shopingCart">Shoping Cart</a></li>
                                    <li><a href="<?= base_url(); ?>/checkout">Check Out</a></li>
                                    <li><a href="<?= base_url(); ?>/blogeDtails">Blog Details</a></li>
                                </ul>
                            </li>
                            <li><a href="<?= base_url(); ?>/blog">Blog</a></li>
                            <li><a href="<?= base_url(); ?>/contact">Contact</a></li>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large" src="/Assets/img/product/details/product-details-1.jpg" alt="">
                        </div>
                    ...
                    <div class="footer__copyright">
                        <div class="footer__copyright__text">
                            <p>
                                ...
                                </script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="#" target="_blank">SCHOOLSHOP</a>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </p>
                        </div>
